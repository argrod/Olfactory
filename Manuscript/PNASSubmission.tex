...
\section{Results}
    ...
    \subsection{Wind conditions across foraging trips}
        As shearwaters approached foraging spots, their use of wind conditions shifted from bimodal sidewind distributions to near headwind conditions (Figures \ref{fig:largeDists, fig:distDest}). Once within 20 km of the next foraging point, birds flew in headwinds to a greater degree.
...
% distrelDensity
% individual plot
% dispdist (concentration of flight into the wind when <20 km to > ~8)
% table of r bar and HR test results?

\begin{figure}%[tbhp]
    \centering
    \includegraphics[width=.8\linewidth]{Figures/DistRelDensity}
    \caption{Kernel density estimates of densities of relative wind headings in 10 km bins from the next foraging point.}
    \label{fig:distrelDensity}
\end{figure}

\begin{figures}
    \centering
    \includegraphics[width=.8\linewidth]{Figures/IndivPlot.eps}
    \caption{Path of a shearwater approaching a foraging point (green circle) with estimated wind vectors displayed. Colours of vector arrows refer to wind speeds (m/s).}
    \label{fig:IndivPlot}
\end{figure}
...
% \centering
% \includegraphics[width=11.4cm,height=11.4cm]{Figures/IndivPlot}
% \caption{Path of a shearwater approaching a foraging point (green circle) with estimated wind vectors displayed. Colours of vector arrows refer to wind speeds (m/s).}\label{fig:side}
% \end{SCfigure*}
...
\matmethods{
    Streaked shearwaters were tagged in Funakoshi-Ohshima Island (39\textdegree24'N,141\textdegree59'E) during the breeding seasons of 2018 and 2019 (see \citep{Garrod_2021} for full details). Birds were tagged with GPS and acceleration (AxyTrek) tags (Axy-Trek Marine, Technosmart, Guidonia Montecelio, Italy) attached to the back feathers with waterproof tape (Tesa, Hamburg, Germany) and instant glue (Loctite, D{\"u}sseldorf, Germany). Eleven of 12 attached tags (7 male, 4 female) were successfully recovered in 2018 and nine tags (7 male, 2 female) in 2019.

\subsection*{Wind estimation}
The wind estimations were calculated using the method of  methods were derived from \citep{Goto_2017}. GPS data were subsampled to a sample rate of one fix per second to reflect that of the original study. Relative wind headings (the direction of the bird relative to the bird's direction of travel) were calculated by subtracting the b
}
