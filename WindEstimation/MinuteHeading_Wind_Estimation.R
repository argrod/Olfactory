...
# outfile<-paste("/Users/arang/OneDrive - The University of Tokyo/PhD/Data/Simulated/Goto2017Simulation/WindEst.csv",sep=", ")
...
if(Sys.info()['sysname'] == "Darwin"){
	...
	outfile<-paste("F:/UTokyoDrive/PhD/Data/2018Shearwater/WindEst/MinuteGotoVersion/", sep=",")
	infile <- "F:/UTokyoDrive/PhD/Data/2018Shearwater/AxyTrek/"
}
